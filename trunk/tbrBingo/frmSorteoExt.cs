...
namespace tbrBingo
{
    public partial class frmSorteoExt : Form
    {
        ...
        int lastBolilla = -1;//salas dice que le duplica las bolas ?!?!??!
        //------------------------------------------------------------------------------
        ...
        {
            //carlos salas dice que le sale duplicado a veces ?!?!??!
            //aqui no pasa nunca pero podemos evitarlo
            if (lastBolilla != pNumeroBolilla)
                {AgregarBolilla(pNumeroBolilla);
                SeleccionarElementoTabla(pNumeroBolilla);}

            lastBolilla = pNumeroBolilla;
        }
